public class World
{
    ...
    public static void PopulateLocations()
    {
        ...
        Location forest = new Location(1, "Forest", "A shadowed, twisted woodland where sunlight never breaks through the canopy. Whispers haunt the air, and those who enter rarely return unchanged.", true);
